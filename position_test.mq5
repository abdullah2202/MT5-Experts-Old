/*
Bollinger Band - Averaging:18, SD:2, Shift: 5, Timeframe: 5 Minute
MACD - Fast:9, Slow:26, Signal: 6, Timeframe 20 Minutes
------- 7,19,3, 20M
MFI - Weekly , 14
*/
...
input int bb_averaging = 18;                       // BBands - Averging
input int bb_sd = 2;                               // BBands - Sandard Deviation
input int bb_shift = 5;                            // BBands - Shift
input int macd_fast = 9;                           // MACD Fast
input int macd_slow = 26;                          // MACD Slow
input int macd_signal = 6;                         // MACD Signal
input ENUM_TIMEFRAMES macd_timeframe = PERIOD_M20; // MACD Timeframe
input ENUM_TIMEFRAMES mfi_timeframe = PERIOD_H6;   // MFI Timeframe
input int mfi_period = 25;                         // MFI MA Period
